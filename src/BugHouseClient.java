...
public class BugHouseClient {
	...
	public static void main(String[] args) 
		...
		BugHouseClient gui = new BugHouseClient(hostName, portNum);
	...
	// constructor
	public BugHouseClient(String host, int port) 
...
//		stdIn = new BufferedReader(new InputStreamReader(System.in));
		...
		// set-up frame
		frame.setTitle("BugHouse Client");
